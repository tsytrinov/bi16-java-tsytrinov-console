...
public class CreditCardDAOImpl implements ICreditCardDAO {
    ...
    private static final String INSERT = "INSERT INTO CreditCard(Cash_amount, Acc_Account_ID) VALUES(?, ?)";
    private static final String UPDATE = "UPDATE CreditCard SET Cash_amount=?, Acc_Account_ID=? WHERE CreditCard_ID=?";
    ...
    public int update(CreditCard creditCard) {
        ...
        try {
            ...
            stmt.setInt(2, creditCard.getAccountID());
